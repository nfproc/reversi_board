...
module reversi_accel_Axi2AxiStream_Pipeline_MMIterInLoop1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [20:0] i_V_fu_56;
wire    ap_loop_init;
reg   [20:0] ap_sig_allocacmp_i_V_9;
wire   [20:0] i_V_10_fu_102_p2;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ldata1_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln952_reg_131 == 1'd0) & (m_axi_data_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ldata1_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln952_reg_131 == 1'd0) & (m_axi_data_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ldata1_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln952_reg_131 == 1'd0) & (m_axi_data_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln952_reg_131 == 1'd0) & (m_axi_data_RVALID == 1'b0));
end
...
assign i_V_10_fu_102_p2 = (ap_sig_allocacmp_i_V_9 + 21'd1);

assign icmp_ln952_fu_96_p2 = ((ap_sig_allocacmp_i_V_9 == p_read1) ? 1'b1 : 1'b0);

assign ldata1_din = data_addr_read_reg_135;
...
endmodule //reversi_accel_Axi2AxiStream_Pipeline_MMIterInLoop1
