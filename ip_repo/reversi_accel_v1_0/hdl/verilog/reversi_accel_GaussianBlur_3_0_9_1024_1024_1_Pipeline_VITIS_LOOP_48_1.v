...
module reversi_accel_GaussianBlur_3_0_9_1024_1024_1_Pipeline_VITIS_LOOP_48_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [31:0] sext_ln49_fu_119_p1;
...
reversi_accel_fexp_32ns_32ns_32_10_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fexp_32ns_32ns_32_10_full_dsp_1_U81(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(32'd0),
    .din1(mul6_i_reg_184),
...
assign grp_fu_163_p_din0 = ap_sig_allocacmp_sum_load_1;

assign grp_fu_163_p_din1 = t_reg_189;

assign grp_fu_163_p_opcode = 2'd0;

assign grp_fu_167_p_ce = 1'b1;

assign grp_fu_167_p_din0 = grp_fu_70_p0;

assign grp_fu_167_p_din1 = grp_fu_70_p1;

assign grp_fu_171_p_ce = 1'b1;

assign grp_fu_171_p_din0 = sext_ln49_fu_119_p1;

assign icmp_ln48_fu_96_p2 = ((ap_sig_allocacmp_i_4 == 2'd3) ? 1'b1 : 1'b0);

assign sext_ln49_fu_119_p1 = $signed(add_ln49_reg_163);

assign sum_1_out = sum_fu_38;

assign trunc_ln49_cast_fu_127_p1 = i_4_reg_154_pp0_iter4_reg;

endmodule //reversi_accel_GaussianBlur_3_0_9_1024_1024_1_Pipeline_VITIS_LOOP_48_1
