...
entity reversi_accel_Array2xfMat_32_9_1024_1024_1_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of reversi_accel_Array2xfMat_32_9_1024_1024_1_s is 
...
attribute shreg_extract : string;
    ...
    signal stride_read_reg_115 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_Axi2Mat_fu_92_mat_in_4228_din : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_Axi2Mat_fu_92_mat_in_4228_write : STD_LOGIC;
...
begin
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, stride_empty_n, mat_in_rows_c_full_n, mat_in_cols_c_full_n, ap_CS_fsm_state3, ap_block_state3_on_subcall_done)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (mat_in_cols_c_full_n = ap_const_logic_0) or (mat_in_rows_c_full_n = ap_const_logic_0) or (stride_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(real_start, ap_done_reg, stride_empty_n, mat_in_rows_c_full_n, mat_in_cols_c_full_n)
    begin
        if (((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (mat_in_cols_c_full_n = ap_const_logic_0) or (mat_in_rows_c_full_n = ap_const_logic_0) or (stride_empty_n = ap_const_logic_0))) then 
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, stride_empty_n, mat_in_rows_c_full_n, mat_in_cols_c_full_n)
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (mat_in_cols_c_full_n = ap_const_logic_0) or (mat_in_rows_c_full_n = ap_const_logic_0) or (stride_empty_n = ap_const_logic_0));
    end process;
    ...
    mat_in_cols_c_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, stride_empty_n, mat_in_rows_c_full_n, mat_in_cols_c_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (mat_in_cols_c_full_n = ap_const_logic_0) or (mat_in_rows_c_full_n = ap_const_logic_0) or (stride_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    mat_in_data_din <= grp_Axi2Mat_fu_92_mat_in_4228_din;

    mat_in_data_write_assign_proc : process(grp_Axi2Mat_fu_92_mat_in_4228_write, ap_CS_fsm_state3)
    begin
    ...
    mat_in_rows_c_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, stride_empty_n, mat_in_rows_c_full_n, mat_in_cols_c_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (mat_in_cols_c_full_n = ap_const_logic_0) or (mat_in_rows_c_full_n = ap_const_logic_0) or (stride_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    stride_read_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, stride_empty_n, mat_in_rows_c_full_n, mat_in_cols_c_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (mat_in_cols_c_full_n = ap_const_logic_0) or (mat_in_rows_c_full_n = ap_const_logic_0) or (stride_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
