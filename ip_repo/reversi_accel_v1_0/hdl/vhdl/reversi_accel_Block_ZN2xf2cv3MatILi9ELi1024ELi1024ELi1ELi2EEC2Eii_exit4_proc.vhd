...
entity reversi_accel_Block_ZN2xf2cv3MatILi9ELi1024ELi1024ELi1ELi2EEC2Eii_exit4_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of reversi_accel_Block_ZN2xf2cv3MatILi9ELi1024ELi1024ELi1ELi2EEC2Eii_exit4_proc is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln71_fu_80_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln71_reg_348 : STD_LOGIC_VECTOR (0 downto 0);
    signal sub_ln72_fu_86_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal sub_ln72_reg_353 : STD_LOGIC_VECTOR (31 downto 0);
    signal lshr_ln72_1_reg_359 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal sub_ln72_1_fu_92_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln72_fu_115_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal lshr_ln72_2_fu_124_p4 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_fu_108_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal sub_ln72_2_fu_118_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln72_1_fu_133_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln72_fu_137_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal shl_ln_fu_145_p3 : STD_LOGIC_VECTOR (33 downto 0);
    signal select_ln71_fu_153_p3 : STD_LOGIC_VECTOR (33 downto 0);
    signal sext_ln22_fu_160_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                ...
                lshr_ln72_1_reg_359 <= sub_ln72_1_fu_92_p2(31 downto 1);
                sub_ln72_reg_353 <= sub_ln72_fu_86_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, stride_c_full_n)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_start = ap_const_logic_0) or (stride_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    add_ln22_fu_164_p2 <= std_logic_vector(signed(sext_ln22_fu_160_p1) + signed(data_in));
    ap_CS_fsm_state1 <= ap_CS_fsm(0);
    ap_CS_fsm_state2 <= ap_CS_fsm(1);

    ap_ST_fsm_state1_blk_assign_proc : process(ap_start, ap_done_reg, stride_c_full_n)
    begin
        if (((ap_start = ap_const_logic_0) or (stride_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) then 
    ...
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (stride_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    ap_return_26_assign_proc : process(ap_CS_fsm_state2, add_ln22_fu_164_p2, ap_return_26_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    icmp_ln71_fu_80_p2 <= "1" when (stride = ap_const_lv32_FFFFFFFF) else "0";
    lshr_ln72_2_fu_124_p4 <= sub_ln72_reg_353(31 downto 1);
    select_ln71_fu_153_p3 <= 
        ap_const_lv34_0 when (icmp_ln71_reg_348(0) = '1') else 
        shl_ln_fu_145_p3;
    select_ln72_fu_137_p3 <= 
        sub_ln72_2_fu_118_p2 when (tmp_fu_108_p3(0) = '1') else 
        zext_ln72_1_fu_133_p1;
        sext_ln22_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(select_ln71_fu_153_p3),64));

    shl_ln_fu_145_p3 <= (select_ln72_fu_137_p3 & ap_const_lv2_0);
    ...
    sub_ln72_1_fu_92_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(sub_ln72_fu_86_p2));
    sub_ln72_2_fu_118_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(zext_ln72_fu_115_p1));
    sub_ln72_fu_86_p2 <= std_logic_vector(unsigned(stride) - unsigned(width));
    tmp_fu_108_p3 <= sub_ln72_reg_353(31 downto 31);
    zext_ln72_1_fu_133_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln72_2_fu_124_p4),32));
    zext_ln72_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln72_1_reg_359),32));
end behav;
