...
attribute shreg_extract : string;
    ...
    signal icmp_ln1057_fu_1069_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln870_fu_1075_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal icmp_ln1065_fu_1347_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln602_fu_1352_p1 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    mux_606_12_1_1_U2254 : component reversi_accel_mux_606_12_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 12,
    ...
    mux_606_12_1_1_U2255 : component reversi_accel_mux_606_12_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 12,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln1057_fu_1069_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    maxangle_V_2_fu_296 <= add_ln870_fu_1075_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1057_fu_1069_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln870_fu_1075_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_n_V) + unsigned(ap_const_lv6_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1057_fu_1069_p2)
    begin
        if (((icmp_ln1057_fu_1069_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln1057_fu_1069_p2 <= "1" when (ap_sig_allocacmp_n_V = ap_const_lv6_3C) else "0";
    icmp_ln1065_fu_1347_p2 <= "1" when (unsigned(maxfinal_V_1_reg_1438) > unsigned(maxfinal_V_fu_292)) else "0";
    maxangle_V_1_out <= maxangle_V_1_fu_284;

    maxangle_V_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln1057_fu_1069_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1057_fu_1069_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    maxangle_V_5_fu_1355_p3 <= 
        zext_ln602_fu_1352_p1 when (icmp_ln1065_fu_1347_p2(0) = '1') else 
        maxangle_V_1_fu_284;
    maxfinal_V_2_fu_1370_p3 <= 
        maxfinal_V_1_reg_1438 when (icmp_ln1065_fu_1347_p2(0) = '1') else 
        maxfinal_V_fu_292;
    maxrho_V_3_fu_1363_p3 <= 
        maxrho_V_2_reg_1444 when (icmp_ln1065_fu_1347_p2(0) = '1') else 
        maxrho_V_1_fu_288;
    maxrho_V_4_out <= maxrho_V_1_fu_288;

    maxrho_V_4_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln1057_fu_1069_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1057_fu_1069_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    zext_ln602_fu_1352_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(n_V_reg_1430),10));
end behav;
