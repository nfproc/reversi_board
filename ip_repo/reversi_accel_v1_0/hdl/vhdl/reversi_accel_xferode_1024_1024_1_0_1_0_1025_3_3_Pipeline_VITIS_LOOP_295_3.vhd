...
entity reversi_accel_xferode_1024_1024_1_0_1_0_1025_3_3_Pipeline_VITIS_LOOP_295_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of reversi_accel_xferode_1024_1024_1_0_1_0_1025_3_3_Pipeline_VITIS_LOOP_295_3 is 
...
begin
    ...
    add_ln870_fu_90_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_col_V_5_0_load) + unsigned(ap_const_lv13_1));
    ...
    zext_ln1057_fu_80_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_col_V_5_0_load),16));
    zext_ln573_fu_96_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_col_V_5_0_load),64));
end behav;
