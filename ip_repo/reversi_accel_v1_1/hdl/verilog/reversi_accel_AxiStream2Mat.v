...
wire   [23:0] AxiStream2MatStream_2_U0_mat_in_data323_din;
wire    AxiStream2MatStream_2_U0_mat_in_data323_write;
...
reversi_accel_fifo_w32_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
reversi_accel_fifo_w32_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc_U0_ap_idle & AxiStream2MatStream_2_U0_ap_idle);
...
assign cols_read = entry_proc_U0_cols_read;
...
assign mat_in_data323_din = AxiStream2MatStream_2_U0_mat_in_data323_din;

assign mat_in_data323_write = AxiStream2MatStream_2_U0_mat_in_data323_write;

assign rows_read = entry_proc_U0_rows_read;
