...
entity reversi_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of reversi_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1021_reg_131 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal data_addr_read_reg_135 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal c_V_fu_56 : STD_LOGIC_VECTOR (20 downto 0);
    signal c_V_2_fu_102_p2 : STD_LOGIC_VECTOR (20 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_c_V_1 : STD_LOGIC_VECTOR (20 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1021_reg_131 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_data_RVALID, icmp_ln1021_reg_131, ldata_full_n)
    begin
                ap_block_pp0_stage0_01001 <= (((ldata_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((icmp_ln1021_reg_131 = ap_const_lv1_0) and (m_axi_data_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_data_RVALID, icmp_ln1021_reg_131, ldata_full_n)
    begin
                ap_block_pp0_stage0_11001 <= (((ldata_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((icmp_ln1021_reg_131 = ap_const_lv1_0) and (m_axi_data_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_data_RVALID, icmp_ln1021_reg_131, ldata_full_n)
    begin
                ap_block_pp0_stage0_subdone <= (((ldata_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((icmp_ln1021_reg_131 = ap_const_lv1_0) and (m_axi_data_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_data_RVALID, icmp_ln1021_reg_131)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln1021_reg_131 = ap_const_lv1_0) and (m_axi_data_RVALID = ap_const_logic_0));
    end process;
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln1021_reg_131, ap_block_pp0_stage0_subdone)
    begin
        if (((icmp_ln1021_reg_131 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_c_V_1 <= ap_const_lv21_0;
        else 
            ap_sig_allocacmp_c_V_1 <= c_V_fu_56;
        end if; 
    end process;

    c_V_2_fu_102_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_c_V_1) + unsigned(ap_const_lv21_1));

    data_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_data_RVALID, icmp_ln1021_reg_131, ap_block_pp0_stage0)
    begin
        if (((icmp_ln1021_reg_131 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    icmp_ln1021_fu_96_p2 <= "1" when (ap_sig_allocacmp_c_V_1 = cols_addrbound) else "0";
    ...
    ldata_din <= data_addr_read_reg_135;
    ...
    m_axi_data_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln1021_reg_131, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1021_reg_131 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
