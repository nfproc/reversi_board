...
attribute shreg_extract : string;
    ...
    signal entry_proc_U0_rows_read : STD_LOGIC;
    signal entry_proc_U0_rows_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc_U0_rows_c_write : STD_LOGIC;
    signal entry_proc_U0_cols_read : STD_LOGIC;
    ...
    signal AxiStream2MatStream_2_U0_mat_in_data323_din : STD_LOGIC_VECTOR (23 downto 0);
    signal AxiStream2MatStream_2_U0_mat_in_data323_write : STD_LOGIC;
    ...
    component reversi_accel_fifo_w32_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        rows_read => entry_proc_U0_rows_read,
        ...
        cols_read => entry_proc_U0_cols_read,
    ...
    port map (
        ...
        mat_in_data323_din => AxiStream2MatStream_2_U0_mat_in_data323_din,
        ...
        mat_in_data323_write => AxiStream2MatStream_2_U0_mat_in_data323_write,
    ...
    rows_c_U : component reversi_accel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    cols_c_U : component reversi_accel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= AxiStream2MatStream_2_U0_ap_done;
    ap_idle <= (last_blk_pxl_width_U0_ap_idle and (last_blk_width_channel_empty_n xor ap_const_logic_1) and entry_proc_U0_ap_idle and AxiStream2MatStream_2_U0_ap_idle);
