...
entity reversi_accel_GaussianBlur_3_0_16_1024_1024_1_2_2_Pipeline_VITIS_LOOP_48_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of reversi_accel_GaussianBlur_3_0_16_1024_1024_1_2_2_Pipeline_VITIS_LOOP_48_1 is 
...
begin
    sitofp_32s_32_6_no_dsp_1_U81 : component reversi_accel_sitofp_32s_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    fexp_32ns_32ns_32_10_full_dsp_1_U82 : component reversi_accel_fexp_32ns_32ns_32_10_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 10,
        din0_WIDTH => 32,
    ...
    grp_fu_165_p_din0 <= ap_sig_allocacmp_sum_load_1;
    grp_fu_165_p_din1 <= t_reg_189;
    grp_fu_165_p_opcode <= ap_const_lv2_0(1 - 1 downto 0);
    grp_fu_169_p_ce <= ap_const_logic_1;
    grp_fu_169_p_din0 <= grp_fu_70_p0;
    grp_fu_169_p_din1 <= grp_fu_70_p1;
    ...
    begin
        ...
        grp_fu_75_p0 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln49_reg_163),32));
